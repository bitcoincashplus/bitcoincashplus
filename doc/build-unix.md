UNIX BUILD NOTES
====================
Some notes on how to build Bitcoin Cash Plus in Unix.
...
memory available when compiling Bitcoin Cash Plus. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Bitcoin Cash Plus without wallet.
...
# Configure Bitcoin Cash Plus to use our own-built instance of BDB
cd $BITCOIN_ROOT
./autogen.sh
