...
BOOST_AUTO_TEST_CASE(get_next_work) {
    ...
    const Consensus::Params &params = config.GetChainParams().GetConsensus();
     ...
     BOOST_CHECK_EQUAL(BitcoinCalculateNextWorkRequired(&pindexLast, nLastRetargetTime, params), 0x1d00d86a);
...
BOOST_AUTO_TEST_CASE(get_next_work_pow_limit) {
    ...
    const Consensus::Params &params = config.GetChainParams().GetConsensus();
     ...
     pindexLast.nBits = 0x1d00ffff;
     BOOST_CHECK_EQUAL(BitcoinCalculateNextWorkRequired(&pindexLast, nLastRetargetTime, params), 0x1d00ffff);
}
...
BOOST_AUTO_TEST_CASE(get_next_work_lower_limit_actual) {
    ...
    BOOST_CHECK_EQUAL(BitcoinCalculateNextWorkRequired(&pindexLast, nLastRetargetTime, params), 0x1c0168fd);
}
...
BOOST_AUTO_TEST_CASE(get_next_work_upper_limit_actual) {
    ...
    BOOST_CHECK_EQUAL(BitcoinCalculateNextWorkRequired(&pindexLast, nLastRetargetTime, params), 0x1d00e1fd);
}
...
BOOST_AUTO_TEST_CASE(BitcoinCashPlusPreminingBegin_test)
{
    const auto chainParams = Params(CBaseChainParams::MAIN);
...
BOOST_AUTO_TEST_CASE(BitcoinCashPlusPreminingEnd_test)
{
   /* const auto chainParams = Params(CBaseChainParams::MAIN);
