...
// Windows < Vista: C:\Documents and Settings\Username\Application Data\BitcoinCashPlus
// Windows >= Vista: C:\Users\Username\AppData\Roaming\BitcoinCashPlus
// Mac: ~/Library/Application Support/BitcoinCashPlus
// Unix: ~/.bitcoincashplus
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BitcoinCashPlus";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/BitcoinCashPlus";
#else
    // Unix
    return pathRet / ".bitcoincashplus";
#endif
#endif
}
