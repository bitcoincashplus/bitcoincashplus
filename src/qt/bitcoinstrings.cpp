...
static const char UNUSED *bitcoin_strings[] = {
    QT_TRANSLATE_NOOP("bitcoincashplus", "Bitcoin Cash Plus"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "The %s developers"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      ""
    ...
    QT_TRANSLATE_NOOP("bitcoincashplus", "%s corrupt, salvage failed"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "%s is set very high!"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "(default: %s)"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "(default: %u)"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "-maxmempool must be at least %d MB"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "<category> can be:"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
    ...
    QT_TRANSLATE_NOOP("bitcoincashplus", "Append comment to the user agent string"),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
        "Attempt to recover private keys from a corrupt wallet on startup"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Automatically create Tor hidden service (default: %d)"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Block creation options:"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Cannot downgrade wallet"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Cannot resolve -%s address: '%s'"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Cannot write default address"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Chain selection options:"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Change index out of range"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Connect through SOCKS5 proxy"),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
        "Connect to a node to retrieve peer addresses, and disconnect"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Connection options:"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Copyright (C) %i-%i"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Corrupted block database detected"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Debugging/Testing options:"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Do not load the wallet and disable wallet RPC calls"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Do you want to rebuild the block database now?"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Done loading"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Enable publish hash block in <address>"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Enable publish hash transaction in <address>"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Enable publish raw block in <address>"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Enable publish raw transaction in <address>"),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
        "Enable transaction replacement in the memory pool (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Error initializing block database"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Error initializing wallet database environment %s!"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Error loading %s"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Error loading %s: Wallet corrupted"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Error loading %s: Wallet requires newer version of %s"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Error loading %s: You can't disable HD "
                                     "on a already existing HD wallet"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Error loading block database"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Error opening block database"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Error reading from database, shutting down."),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Error"),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
        "Error: A fatal internal error occurred, see debug.log for details"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Error: Disk space is low!"),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
    ...
    QT_TRANSLATE_NOOP("bitcoincashplus", "Importing..."),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
    ...
    QT_TRANSLATE_NOOP("bitcoincashplus", "Information"),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
        "Initialization sanity check failed. %s is shutting down."),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Insufficient funds"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Invalid -onion address: '%s'"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Invalid -proxy address: '%s'"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Invalid amount for -%s=<amount>: '%s'"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
    ...
    QT_TRANSLATE_NOOP("bitcoincashplus", "Listen for JSON-RPC connections on "
                                     "<port> (default: %u or testnet: %u)"),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
        "Listen for connections on <port> (default: %u or testnet: %u)"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Loading addresses..."),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Loading banlist..."),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Loading block index..."),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Loading wallet..."),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Location of the auth cookie (default: data dir)"),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
        "Maintain at most <n> connections to peers (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Make the wallet broadcast transactions"),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
    ...
    QT_TRANSLATE_NOOP("bitcoincashplus", "Node relay options:"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Not enough file descriptors available."),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
        "Only connect to nodes in network <net> (ipv4, ipv6 or onion)"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Options:"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Password for JSON-RPC connections"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Prepend debug output with timestamp (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Print this help message and exit"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Print version and exit"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Prune cannot be configured with a negative value."),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Prune mode is incompatible with -txindex."),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Pruning blockstore..."),
    QT_TRANSLATE_NOOP("bitcoincashplus", "RPC server options:"),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
        "Rebuild chain state and block index from the blk*.dat files on disk"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Rebuild chain state from the currently indexed blocks"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Reducing -maxconnections from %d to %d, "
                                     "because of system limitations."),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Relay and mine data carrier transactions (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Relay non-P2SH multisig (default: %u)"),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
        "Rescan the block chain for missing wallet transactions on startup"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Rescanning..."),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Rewinding blocks..."),
    QT_TRANSLATE_NOOP("bitcoincashplus",
    ...
    QT_TRANSLATE_NOOP("bitcoincashplus", "Set key pool size to <n> (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
    ...
    QT_TRANSLATE_NOOP("bitcoincashplus", "Signing transaction failed"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Specify configuration file (default: %s)"),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
        "Specify connection timeout in milliseconds (minimum: 1, default: %d)"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Specify data directory"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Specify pid file (default: %s)"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Specify wallet file (within data directory)"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Specify your own public address"),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
        "Spend unconfirmed change when sending transactions (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Starting network threads..."),
    QT_TRANSLATE_NOOP("bitcoincashplus", "The source code is available from %s."),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "The transaction amount is too small to pay the fee"),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
        "The wallet will avoid paying less than the minimum relay fee."),
    QT_TRANSLATE_NOOP("bitcoincashplus", "This is experimental software."),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
    ...
    QT_TRANSLATE_NOOP("bitcoincashplus", "Transaction amount too small"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
    ...
    QT_TRANSLATE_NOOP("bitcoincashplus", "Transaction too large for fee policy"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Transaction too large"),
    QT_TRANSLATE_NOOP(
        "bitcoincashplus",
        "Unable to bind to %s on this computer (bind returned error %s)"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Unable to bind to %s on this computer. "
    ...
    QT_TRANSLATE_NOOP("bitcoincashplus", "Use the test chain"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "User Agent comment (%s) contains unsafe characters."),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Username for JSON-RPC connections"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Verifying blocks..."),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Verifying wallet..."),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Wallet %s resides outside data directory %s"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Wallet debugging/testing options:"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Wallet needed to be rewritten: restart %s to complete"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Wallet options:"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Warning"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Warning: unknown new rules activated (versionbit %i)"),
    QT_TRANSLATE_NOOP("bitcoincashplus",
                      "Whether to operate in a blocks only mode (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoincashplus", "Zapping all transactions from wallet..."),
    QT_TRANSLATE_NOOP("bitcoincashplus", "ZeroMQ notification options:"),
};
