...
enum ServiceFlags : uint64_t {
    ...
    // It is currently set by all Bitcoin Cash Plus nodes, and is unset by SPV clients
    ...
    // protocol request. Bitcoin Cash Plus does not support this but a patch set
    ...
    // connections. Bitcoin Cash Plus nodes used to support this by default, without
